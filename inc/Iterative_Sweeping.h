...
#define DEBUG_IT_SWEEP		0 || DEBUG

#define EPSILON_ERROR		0.01

class Iterative_Sweeping : public Hybrid_Planner, public Sweeping_Approach {
public:
	Iterative_Sweeping();
	virtual ~Iterative_Sweeping();
